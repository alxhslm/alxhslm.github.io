...
| Pros                                                                                          | Cons                                                                                                                                                                                                                  |
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Free on all platforms                                                                         | Have to manage different Google accounts separately. However, you can sync a personal iCal feed (read-only) to your work calendar and vice versa. Personally I prefer to keep my work and personal accounts separate. |
