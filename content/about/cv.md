...
{{< accordionItem title="Optimisation" >}}
{{< keywordList >}}
{{< keyword icon="cvxpy" >}} CVXPY {{< /keyword >}}
{{< keyword icon="optuna" >}} Optuna {{< /keyword >}}
{{< keyword icon="casadi" >}} CasADi {{< /keyword >}}
{{< /keywordList >}}
{{< /accordionItem >}}

{{< accordionItem title="Mathematical Modelling" >}}
{{< keywordList >}}
{{< keyword >}} Numerical methods {{< /keyword >}}
{{< keyword >}} Physics-based modelling {{< /keyword >}}
{{< /keywordList >}}
{{< /accordionItem >}}

{{< accordionItem title="Data visualisation" >}}
{{< keywordList >}}
...
{{< accordionItem title="Experiment Management" >}}
{{< keywordList >}}
...
{{< accordionItem title="Software Development" >}}
{{< keywordList >}}
...
{{< accordionItem title="Cloud & Infrastructure" >}}
{{< keywordList >}}
